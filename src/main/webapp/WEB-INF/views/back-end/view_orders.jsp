                                    ...
                                    <tbody>
                                       <c:forEach items="${orders }" var="order" varStatus="loop">
	                                        <tr>
	                                            ...
	                                            <td data-label="ID" rowspan="${order.saleOrderProducts.size() + 1 }">${order.user.username}</td>
	                                            <td data-label="Email" rowspan="${order.saleOrderProducts.size() + 1 }">${order.customerEmail }</td>
	                                        ...
	                                        <tr>
		                                            ...
		                                            <td data-label="Địa chỉ" rowspan="${order.saleOrderProducts.size() + 1 }">${order.customerAddress }</td>
		                                            <td data-label="Xoá" class="right__iconTable" rowspan="${order.saleOrderProducts.size() + 1 }" id="cancel-${order.id }">
		                                            	<c:choose>
		                                            ...
		                                            <td data-label="Thanh toán" class="right__confirm" rowspan="${order.saleOrderProducts.size() + 1 }">
		                                                ...
		                                                <a href="javascript:void(0)"onclick="shop2.is_ship(${order.id})"  class="right__iconTable"><img src="${pageContext.request.contextPath}/assets/icon-x.svg" alt=""></a>
		                                            </td>
		                                        </tr>
